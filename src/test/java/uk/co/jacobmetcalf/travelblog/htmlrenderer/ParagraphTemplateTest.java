...
public class ParagraphTemplateTest {
  ...
  public void renders_a_single_textual_element() {
    String actualHtml = test_rendering(ImmutableParagraph.builder()
  ...
  private String test_rendering(Paragraph paragraph) {
    return ParagraphTemplate.template.render(paragraph);
  }
}